...
<html lang="pt-br">
<head>
  <title>Página Inicial - UaiOu</title>
  ...
  <header><!-- Início Cabeçalho -->
    <nav class="navbar navbar-expand-lg navbar-light">
        <div class="container">
            ...
            <a href="<?= base_url('home') ?>" class="navbar-brand d-flex align-items-end"><!-- Início Logo -->
              <h1 class=" d-flex align-items-end mr-2" style="color: #FE621D;">
                <span class="mr-2">UaiOu</span>
            ...
            <div class="collapse navbar-collapse" id="nav-principal"><!-- Início Itens Menu -->
              <ul class="navbar-nav ml-auto">
                  <li class="nav-item mr-3">
                      <a class="nav-link" href="<?= base_url('home') ?>">Página Inicial</a>
                  </li>
                  <li class="nav-item mr-3">
